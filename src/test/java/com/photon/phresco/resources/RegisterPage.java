...
public class RegisterPage {
	...
	/** Tap on the register button from home screen **/
	public static void clickRegistrationButton() throws Exception{
		CommonUtils.clickElement(ElementType.CLASS, HeaderLinksPage.USER_REG, "registration button");
	}
	...
	public static void enterEmailId() throws Exception{
		String emailId = CommonUtils.properties.getProperty("email_prefix") + CommonUtils.timeStamp() + CommonUtils.properties.getProperty("email_suffix");
		CommonUtils.enterData(ElementType.ID, REGISTER_EMAIL_TEXTFIELD, emailId);
	}
	...
	public static void enterPhoneno() throws Exception{
		CommonUtils.enterData(ElementType.ID, REGISTER_PHONE_TEXTFIELD, CommonUtils.properties.getProperty("register_phone_value"));
	}
	
	/** Enter first name and last name into the first name and last name field **/
	public static void enterName() throws Exception{
		CommonUtils.enterData(ElementType.ID, REGISTER_FIRSTNAME_TEXTFIELD, CommonUtils.properties.getProperty("register_firstname_value"));
	   	CommonUtils.enterData(ElementType.ID, REGISTER_LASTNAME_TEXTFIELD, CommonUtils.properties.getProperty("register_lastname_value"));
	}
