...
public class ExpressRegisterPage {
	public static WebDriver driver;
		...
		public static String EXPRESS_GOLD_CARD_FIELD ="wu_register_gold_mywu_number";
		
				
	public ExpressRegisterPage(WebDriver driver){
		ExpressRegisterPage.driver = driver;
	}
	...
	public static void enterName() throws Exception{
		CommonUtils.enterData(ElementType.ID, REGISTER_FIRSTNAME_TEXTFIELD, CommonUtils.properties.getProperty("express_fname"));
	   	CommonUtils.enterData(ElementType.ID, REGISTER_LASTNAME_TEXTFIELD, CommonUtils.properties.getProperty("express_lname"));
	}
	
	/** Enter loyalty number into loyalty number field **/
	public static void enterGoldCard() throws Exception{
		CommonUtils.enterData(ElementType.ID, EXPRESS_GOLD_CARD_FIELD, CommonUtils.properties.getProperty("express_gold_card_no"));
	}
	...
	public static void verifyPrePopulatedValues() throws Exception{
		CommonUtils.verifyPrePopulatedFld(ElementType.ID, REGISTER_EMAIL_TEXTFIELD, "register email field");
		CommonUtils.verifyPrePopulatedFld(ElementType.ID, REGISTER_FIRSTNAME_TEXTFIELD, "register first name");
		CommonUtils.verifyPrePopulatedFld(ElementType.ID, REGISTER_LASTNAME_TEXTFIELD, "register last name");
		CommonUtils.verifyPrePopulatedFld(ElementType.ID, REGISTER_ADDRESS_LINE1_TEXTFIELD, "addressline 1 field");
		CommonUtils.verifyPrePopulatedFld(ElementType.ID, REGISTER_CITY_TEXTFIELD, "city field");
		CommonUtils.verifyPrePopulatedFld(ElementType.ID, REGISTER_ZIPCODE_TEXTFIELD, "zip code field");
	}
	
	public static void expressRegisterTest()throws Exception{
		navigateExpress();
		enterName();
		enterGoldCard();
		enterPhoneno();
		enterCaptchValue();
		CommonUtils.getFocus(ElementType.ID, RST_CAPTCHA_IMAGE);
		clickContinueButton();
		CommonUtils.waitForElement(ElementType.ID, REGISTER_EMAIL_TEXTFIELD);
		registerScreenVerification();
		//verifyPrePopulatedValues();
		enterPassword();
		enterPhoneno();
		selectQuestion1();
		enterAnswer1();
